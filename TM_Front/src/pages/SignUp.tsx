...
import { TextField, Button, Stack, Typography, Dialog, DialogTitle, DialogContent, DialogActions, Box } from "@mui/material";
  ...
  return (
   ...
   >
    ...
    <Stack spacing={2} sx={{ width: 300}}>
      ...
      <TextField label="아이디" name="loginId" value={form.loginId} onChange={handleChange} />
      <Button onClick={checkDuplicateId}>중복 <br></br>확인 </Button>
      </Stack>      

      <TextField
        label="비밀번호" name="password" type="password" value={form.password} onChange={handleChange} />
      <TextField
        label="비밀번호 확인" name="passwordConfirm" type="password" value={form.passwordConfirm} onChange={handleChange}
      ...
      <Button onClick={checkDuplicateNickname}>중복 <br></br>확인</Button>
      </Stack>

      <TextField label="e-mail" name="email" value={form.email} onChange={handleChange} />
      <TextField label="생년월일" name="birth" value={form.birth} onChange={handleChange} />
      <TextField label="전화번호" name="phoneNumber" value={form.phoneNumber} onChange={handleChange} />
      ...
      <TextField label="주소" name="address" value={form.address} onChange={handleChange} disabled />
      <TextField label="상세 주소" name="addressDetail" value={form.addressDetail} onChange={handleChange} />
      ...
      <Dialog open={isPostcodeOpen} onClose={() => setIsPostcodeOpen(false)} fullWidth maxWidth="sm">
