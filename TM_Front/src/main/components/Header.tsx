    ...
    <AppBar position="static" sx={{ background: "#151B54", width: "100vw" }}>
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 3 }}>
          <Button color="inherit" onClick={() => navigate("/board/show/INFO_TIP")}>
            여행 Info/Tip
          </Button>
          <Button color="inherit" onClick={() => navigate("/board/show/QNA")}>
            여행 Q&A
          </Button>
          <Button color="inherit" onClick={() => navigate("/board/show/REVIEW")}>
            여행 Review
          </Button>
          <Button color="inherit" onClick={() => navigate("/board/show/NOTICE")}>
            Notice
          </Button>
        </Box>
